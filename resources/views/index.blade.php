		...
		<div class="row">
			<div class="col-lg-6 col-xl-5 align-self-center mb-5 mb-lg-0">
				<div class="search-content">
					<h2>جستجو مناسب و مقرون به صرفه برای تور خود</h2>
					<p>ما به شما این تضمین را می دهیم که از خرید خود نه تنها پشیمان نشوید بلکه هر بار مشتری خود ما شوید. بهترین قیمت ها را فقط از ما بخواهید...</p>
					<a class="button" href="#">بیشتر بدانید</a>
				</div>
			</div>
			<div class="col-lg-6 col-xl-6 offset-xl-1">
				<div class="search-wrapper">
					<h3>جستجو در پکیج ها</h3>
					<form class="search-form" action="#">
						...
						<div class="form-group">
							<select name="category" id="category">
								<option value="disabled" disabled selected>دسته بندی</option>
								<option value="8 AM">طبیعت گردی</option>
								<option value="12 PM">شب نشینی</option>
							</select>
						</div>
						<div class="form-group">
							<select name="tourDucation" id="tourDuration">
								<option value="disabled" disabled selected>مدت زمان تور</option>
								<option value="8 AM">8 صبح</option>
								<option value="12 PM">12 شب</option>
							</select>
						</div>
						<div class="form-group">
							<div class="input-group">
						...
						<div class="form-group">
							<select name="priceRange" id="priceRange">
								<option value="disabled" disabled selected>رنج قیمت</option>
								<option value="8 AM">تا 20 میلیون</option>
								<option value="12 PM">تا 5 میلیون</option>
							</select>
						</div>
						<div class="form-group">
							<button class="button border-0 mt-3" type="submit">جستجو</button>
						</div>
					</form>
				</div>
			</div>
